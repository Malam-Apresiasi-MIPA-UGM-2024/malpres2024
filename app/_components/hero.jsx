...
const Hero = () => {
  return (
    <div className="md:mt-[5.5rem] mt-[90px] relative font-poppins">
      <div
        className="w-[97vw] h-[550px] md:h-[548px] lg:bg-[url('/banner_malpres.webp')] md:bg-[url('/banner_malpres_mdsm.webp')] bg-[url('/banner_malpres_sm.webp')] mx-auto mt-8 bg-cover bg-center border-2 border-[#E9557F] rounded-lg"
      >
