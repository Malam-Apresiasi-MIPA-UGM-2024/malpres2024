...
export default function NotFound(){
    return(
        <div className="flex inset-0 justify-center items-center h-screen ">
            <div
            className="absolute inset-0 w-fulln h-full"
            style={{
            ...
            <div className="flex flex-col items-center justify-center h-[20rem] w-[50rem]">
                ...
                <p className="font-extrabold text-xs md:text-2xl font-poppins text-pink-600 bg-white px-3 py-1 rounded-lg ">ups🥲 Halaman yang kamu cari tidak ditemukan 💖</p>
            </div>
        </div>
    );
}